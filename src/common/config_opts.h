...
OPTION(mon_osdmap_full_prune_enabled, OPT_BOOL, false)
OPTION(mon_osdmap_full_prune_min, OPT_INT, 10000)
OPTION(mon_osdmap_full_prune_interval, OPT_INT, 10)
OPTION(mon_osdmap_full_prune_txsize, OPT_INT, 100)
